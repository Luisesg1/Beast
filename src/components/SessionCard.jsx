      ...
      <div className="session-header" onClick={onToggle} style={prs.size > 0 ? { borderLeft: "3px solid #f59e0b", paddingLeft: 10 } : {}}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          {(() => {
            ...
            return (
              <span className="ex-count" style={{ color:"var(--accent)", borderColor:"rgba(232,255,0,0.25)", background:"rgba(232,255,0,0.05)" }}>
                🎯 RPE {avg}
              </span>
            );
          })()}
              ...
              <div key={ex.id} style={{ borderBottom: "1px solid var(--border)", paddingBottom: 10, marginBottom: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, paddingTop: 6 }}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {ex.supersetGroup && (
                      <span style={{ fontSize: 8, background: getSupersetColor(ex.supersetGroup, s.exercises || []), color: "#0a0a0a", borderRadius: 3, padding: "1px 5px", marginLeft: 5, fontWeight: 900, letterSpacing: 1, verticalAlign: "middle" }}>SS</span>
                    )}
                  </div>
                    ...
                    {isLong && (
                      <button
                        ...
                        style={{
                          ...
                          color: "rgba(232,255,0,0.5)", fontSize: 10, fontWeight: 700,
