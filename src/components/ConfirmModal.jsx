      ...
      >
        ...
        <div style={{ display:"flex", gap:10 }}>
          ...
          <button
            ...
            style={{ flex:1, padding:"11px 0", borderRadius:10, border:"none", background:"#e8ff00", color:"#0a0a0a", fontSize:14, fontWeight:900, cursor:"pointer", fontFamily:"'Barlow Condensed', sans-serif", letterSpacing:1 }}
          >
            Confirmar
          </button>
        </div>
