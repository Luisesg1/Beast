...
const THEMES = [
  {
    ...
    accent: "#e8ff00", accentDim: "rgba(232,255,0,",
    titleWord1: "#ffffff", titleWord2: "#e8ff00",
    pillBg: "#e8ff00", pillText: "#05050a", isLight: false,
  },
  {
    ...
    <div className="overlay" onClick={onClose}>
      <div className="modal modal-wide" onClick={e => e.stopPropagation()}
        ...
        <div style={{ padding:"0 0 16px" }}>
          ...
          <canvas ref={canvasRef} style={{ width:"100%", borderRadius:12, border:"1px solid rgba(232,255,0,0.2)", display:"block" }} />
