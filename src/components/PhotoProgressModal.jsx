  ...
  return (
    <div style={{ paddingBottom: 16 }}>
        ...
        <div style={{ background: "var(--input-bg)", border: "1px solid var(--accent)", borderRadius: 14, padding: 14, marginBottom: 16 }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: "var(--accent)", letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 10 }}>
            ...
            {exifDate ? (
              <span title="Fecha detectada de la foto">
                {fmtDate(exifDate)}
                <span style={{ marginLeft: 6, background: "rgba(232,255,0,0.15)", borderRadius: 4, padding: "1px 5px", fontSize: 9, letterSpacing: 1 }}>
                  EXIF ✓
                </span>
              </span>
            ) : (
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button onClick={confirmUpload} disabled={uploading}
              style={{ flex: 2, background: "var(--accent)", border: "none", borderRadius: 10, padding: "10px 0", color: "#0a0a0a", cursor: uploading ? "default" : "pointer", fontWeight: 900, fontSize: 13, fontFamily: "Barlow Condensed, sans-serif", letterSpacing: 1, opacity: uploading ? 0.7 : 1 }}>
            ...
            {photos.length >= 2 && (
              <button
                ...
                style={{
                  ...
                  border: compareMode ? "none" : "1px solid rgba(232,255,0,0.3)",
                  background: compareMode ? "var(--accent)" : "rgba(232,255,0,0.06)",
                  color: compareMode ? "#0a0a0a" : "var(--accent)",
      ...
      {compareMode && !showNoteInput && (
        <div style={{
          background: selected.length === 2 ? "rgba(232,255,0,0.06)" : "var(--input-bg)",
            ...
            {[0, 1].map(i => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                <div style={{
                  ...
                  color: selected.length > i ? "#0a0a0a" : "var(--text-muted)",
                  display: "flex", alignItems: "center", justifyContent: "center",
            ...
            canCompare ? (
              <>
                <button onClick={analyzePhotos} style={{
                  ...
                  borderRadius: 10, padding: "12px 0", color: "#0a0a0a",
                  cursor: "pointer", fontFamily: "Barlow Condensed, sans-serif",
              ...
              <button onClick={handleWatchAd} disabled={watchingAd} style={{
                width: "100%", background: "rgba(232,255,0,0.08)",
                border: "1px solid rgba(232,255,0,0.3)", borderRadius: 10,
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: isSelected ? "0 0 14px rgba(232,255,0,0.25)" : "none",
